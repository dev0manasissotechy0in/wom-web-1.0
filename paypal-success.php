...
try {
    ...
    if ($payment_type === 'booking') {
        ...
        $stmt = $db->prepare("UPDATE book_call SET payment_status = 'completed' WHERE id = ?");
            ...
            $email_body = "
                ...
                <head>
                    <style>
                        ...
                        .button { display: inline-block; padding: 15px 30px; background: #0070ba; color: white; text-decoration: none; border-radius: 5px; margin: 20px 0; }
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            ...
                            <p>Thank you for booking a consultation with us! Your payment via PayPal has been successfully processed.</p>
        ...
        $stmt = $db->prepare("UPDATE resource_downloads SET payment_status = 'completed' WHERE id = ?");
        $stmt->execute([$item_id]);
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Thank you for your purchase! Your payment via PayPal has been processed successfully.</p>

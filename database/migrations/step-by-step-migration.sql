-- =====================================================
-- WOM Website - Step by Step Migration
-- Execute these one by one if having issues
-- Date: 2025-11-24
-- =====================================================

-- STEP 1: Create SMTP Settings Table
-- =====================================================
...
-- STEP 2: Insert SMTP Settings (only if table is empty)
-- =====================================================
INSERT IGNORE INTO `smtp_settings` 
(`id`, `smtp_host`, `smtp_port`, `smtp_username`, `smtp_password`, `smtp_encryption`, `from_email`, `from_name`, `is_active`) 
VALUES 
(1, 'smtp.hostinger.com', 465, 'thesaasinsider@wallofmarketing.co', 'U~4nAR1G$9|m', 'ssl', 'thesaasinsider@wallofmarketing.co', 'Wall of Marketing', 1);
...
-- STEP 4: Insert Default Legal Pages (only if not exists)
-- =====================================================
INSERT IGNORE INTO `pages` (`title`, `slug`, `content`, `page_type`, `show_in_footer`, `footer_order`, `status`) VALUES
...
-- STEP 5: Create User Preferences Table (for Dark Mode)
-- =====================================================
...
-- STEP 6: Create/Verify Resource Downloads Table
-- =====================================================
...
-- STEP 7: Create/Verify Newsletter Subscribers Table
-- =====================================================
...
-- STEP 8: Create Site Settings Table
-- =====================================================
...
-- STEP 9: Insert Default Site Settings (only if not exists)
-- =====================================================
...
SELECT 'smtp_settings' as table_name, COUNT(*) as row_count FROM smtp_settings
UNION ALL
...
UNION ALL
SELECT 'resource_downloads', COUNT(*) FROM resource_downloads
UNION ALL
